      ...
      <div className="language-detail">
        <div className="container">
          <div className="error-message">
            ...
            <p>Aranan dil sayfası mevcut değil.</p>
          </div>
        </div>
      </div>
    );
    ...
    <section className="language-detail">
      <div className="container">
        ...
        <div className="language-content">
          <div className="language-descriptions">
            <div className="turkish-description">
              <h2>Hizmetlerimiz</h2>
              <p className="description-text">{language.turkish}</p>
            </div>

            <div className="foreign-description">
              <h2>Our Services / Unsere Dienstleistungen / Nos services</h2>
              <p className="description-text foreign-text">{language.foreign}</p>
            </div>
          </div>

          <div className="services-section">
            <div className="turkish-services">
              <h3 className="services-title">📌 Hizmetlerimiz:</h3>
            ...
            {language.services && language.services.length > 0 && (
              <div className="foreign-services">
                <h3 className="services-title">📌 Our Services / Unsere Dienstleistungen / خدماتنا:</h3>
                <ul className="services-list">
                  {language.services.map((service, index) => (
                    <li key={index} className="service-item foreign-text">
                      <span className="service-bullet">•</span>
                      {service}
                    </li>
                  ))}
          ...
          <div className="contact-cta">
            <div className="cta-card">
              <h3>Bu dilde çeviri hizmeti almak istiyorsanız</h3>
              <p>Profesyonel tercüman kadromuzla size en kaliteli hizmeti sunmaya hazırız.</p>
